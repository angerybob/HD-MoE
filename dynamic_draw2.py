...
# 数据加载
with open("/data/home/haochenhuang/deployment/result2_dynamic.json", "r") as file:
    data = json.load(file)
...
# 显示图形
plt.tight_layout()
plt.savefig("/data/home/haochenhuang/deployment/dynamic_deployment_latency_speedup2.pdf")
