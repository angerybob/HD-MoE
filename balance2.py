...
file_path = f"/data/home/haochenhuang/deployment/results/reasoning_ds_2.5_TFLOPS_75.0_GBPS_for_4*8_mesh_128_batches/arrays_2.5_TFLOPS_75.0_GBPS_in_layer_{layer_id}.npz"
...
# 显示图形
plt.tight_layout()
plt.savefig('/data/home/haochenhuang/deployment/link.png')
plt.close()
print("Figure saved at /data/home/haochenhuang/deployment/link.png")
