...
data_path=f'/data/home/haochenhuang/deployment/evaluation/experts_{dataset}_{model}_pre.json'
#data_path="/data/home/haochenhuang/deployment/evaluation/experts_reasoning_mixtral.json"
sample_path=f'/data/home/haochenhuang/deployment/evaluation/experts_{sample1}_{model}_pre.json'
try:
...
for layer_id in tqdm(range(optimizer.layer)):
    ...
    if layer_id<optimizer.layer-1:
        pre_path = f'/data/home/haochenhuang/deployment/results/{dataset}_{model}_{optimizer.comp*1e-12:.1f}_TFLOPS_{optimizer.BW*1e-9:.1f}_GBPS_for_{mesh_shape[0]:.0f}*{mesh_shape[1]:.0f}_mesh_128_batches/arrays_{optimizer.comp*1e-12:.1f}_TFLOPS_{optimizer.BW*1e-9:.1f}_GBPS_in_layer_{layer_id+1:.0f}.npz'
...
file_path = "/data/home/haochenhuang/deployment/result2_dynamic.json"
