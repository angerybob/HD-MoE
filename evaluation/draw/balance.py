...
layer_id=1
file_path = f"results/reasoning_ds_5.0_TFLOPS_50.0_GBPS_for_4*8_mesh_128_batches/arrays_5.0_TFLOPS_50.0_GBPS_in_layer_{layer_id}.npz"
...
# 显示图形
plt.tight_layout()
plt.savefig('evaluation/figs/ablation/load_imbalance.png')
plt.close()
