...
def main() -> None:
    ...
    optimizer = MoE3DPNMOptimizer(E=num_experts, h=h, B=batch, BW=network_bandwidth*1e9, comp=device_tflops*1e12,routing_trace=data)
    ...
    layer_id=1
    #values = 32 * np.sum(comm_map* P, axis=1)
