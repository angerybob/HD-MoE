...
try:
    with open('/data/home/haochenhuang/deployment/evaluation/experts_reasoning_qwen.json', 'r', encoding='utf-8') as f:
        data1 = json.load(f)
except FileNotFoundError:
    print("文件未找到，请检查文件路径和文件名。")
...
plt.savefig('/data/home/haochenhuang/deployment/motivation.pdf')
print("Figure saved at /data/home/haochenhuang/deployment/motivation.pdf")