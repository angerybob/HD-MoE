...
# 数据加载
with open("/data/home/haochenhuang/deployment/result2_e2e.json", "r") as file:
    data = json.load(file)
...
fig, axs = plt.subplots(len(hardware_configs),len(models), figsize=(18, 14))
...
plt.savefig("/data/home/haochenhuang/deployment/throughput_comparison.pdf")
print("Figure saved at /data/home/haochenhuang/deployment/throughput_comparison.pdf")
