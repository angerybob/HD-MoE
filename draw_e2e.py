...
for layer_id in tqdm(range(optimizer.layer)):
    ...
    comp_path = f'/data/home/haochenhuang/deployment/results/comp_balance_only/{dataset}_{model}_{optimizer.comp*1e-12:.1f}_TFLOPS_{optimizer.BW*1e-9:.1f}_GBPS_for_{mesh_shape[0]:.0f}*{mesh_shape[1]:.0f}_mesh_128_batches/arrays_{optimizer.comp*1e-12:.1f}_TFLOPS_{optimizer.BW*1e-9:.1f}_GBPS_in_layer_{layer_id}.npz'
...
file_path = "/data/home/haochenhuang/deployment/result2_e2e.json"
